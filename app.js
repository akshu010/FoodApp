  ...
  return (
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          src="https://static.vecteezy.com/system/resources/previews/007/500/121/large_2x/food-delivery-icon-clip-art-logo-simple-illustration-free-vector.jpg"
        />
      </div>
...
const RestaurantCard = (props) => {
  const { resData } = props;
  const { name, cuisines, avgRating, slaString } = resData?.data;
  return (
